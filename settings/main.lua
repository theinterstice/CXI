...
xi.settings.main =
{
    ...
    SUBJOB_QUEST_LEVEL             = 1, -- Minimum level to accept either subjob quest.  Set to 0 to start the game with subjobs unlocked.
    ADVANCED_JOB_LEVEL             = 1, -- Minimum level to accept advanced job quests.  Set to 0 to start the game with advanced jobs.
    ...
    AF1_QUEST_LEVEL = 1,    -- Minimum level to start AF1 quest
    AF2_QUEST_LEVEL = 1,    -- Minimum level to start AF2 quest
    AF3_QUEST_LEVEL = 1,    -- Minimum level to start AF3 quest
