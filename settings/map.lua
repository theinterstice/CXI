...
xi.settings.map =
{
    ...
    GARDEN_DAY_MATTERS       = true,
    GARDEN_MOONPHASE_MATTERS = true,
    GARDEN_POT_MATTERS       = true,
    GARDEN_MH_AURA_MATTERS   = true,
